...
const CustomSoftware = () => {
  ...
  useSEO({
    title:
      "Custom Software Development Services | Pragmatic Engineering for Ventures & Enterprises | Indexnine",
    description:
      "Indexnine engineers mission-critical software. Our integrated studios deliver full-stack web, mobile, and enterprise applications using a Pragmatic AI Engineering approach to ensure scalability, security, and measurable business outcomes.",
    keywords:
      "custom software development services, enterprise application development, saas development services, full-stack development company, pragmatic engineering, product modernization, cloud-native development, integrated software teams, mobile application development, web application services",
        ...
        <div className="relative z-10 container mx-auto px-6 pt-48 pb-24">
          <div className="max-w-5xl mx-auto text-center lg:text-left ml-0">
            ...
            <p className="text-base sm:text-lg lg:text-xl text-foreground/85 mb-8 leading-relaxed font-light animate-slide-up font-montserrat">
              We don't just write code, we engineer strategic assets. Our
              integrated teams build secure, scalable, and intelligent
              applications designed to solve your core business challenges and
              drive measurable growth, from venture-backed startups to
          ...
          <div className="max-w-8xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-foreground-dark-muted max-w-3xl mx-auto">
                ...
                and scale your mission-critical applications with
                enterprise-grade quality and startup velocity.
              </p>
            </div>
              ...
              <Card className="p-8 bg-[#fff] border-card-border shadow-lg hover:shadow-xl transition-all duration-300 relative text-foreground-dark flex flex-col">
                <CardContent className="p-0 h-full">
                  ...
                  <p className="text-foreground-dark/80 mb-6">
                    Complex, scalable solutions to streamline your core business
                    operations, from ERPs to internal process automation.
                  </p>
                  ...
                  <p className="text-sm text-foreground-dark/70 mb-4">
                    <strong>Ideal For:</strong> Large organizations needing
                    custom internal tools and process optimization.
                  </p>
                </CardContent>
                <Button variant="btnPrimary" className="w-full">
                  <Link to="/engagement/enterprise">
              ...
              <Card className="p-8 bg-[#000000] border-card-border shadow-lg hover:shadow-xl transition-all duration-300 relative flex flex-col">
                <CardContent className="p-0 h-full">
                  ...
                  <p className="text-foreground/80 mb-6">
                    End-to-end design and development of multi-tenant,
                    cloud-native SaaS platforms ready for commercial success.
                  </p>
                  ...
                  <p className="text-sm text-foreground/70 mb-4">
                    <strong>Ideal For:</strong> Startups and companies building
                    commercial software products for market.
                  </p>
                </CardContent>
                <Button variant="btnSecondary" className="w-full">
                  <Link to="/engagement/innovation-lab">
              ...
              {[
                {
                  ...
                  description:
                    "Native and cross-platform mobile apps for iOS and Android that deliver exceptional user experiences and drive engagement.",
                },
                {
                  icon: Layers,
                  title: "Application Modernization",
                  description:
                    "Transform legacy systems into modern, agile applications that reduce technical debt and unlock new capabilities.",
                },
                {
                  icon: Package,
                  title: "MVP Development",
                  description:
                    "Rapidly build and launch Minimum Viable Products that are strategically architected for future growth and success.",
                },
              ].map((service, index) => (
                <div
                  key={index}
                ...
                >
                  ...
                  <h3 className="relative text-xl font-semibold text-foreground-dark mb-4">
                    {service.title}
                  </h3>
                  <p className="relative text-foreground-dark/80">
                    {service.description}
      ...
      <section id="cta" className={`py-24 lg:py-32 text-white ${styles.ctaBg}`}>
        <div className="container max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-white/80 mb-8">
            ...
            consultation with our senior solutions architects to explore how we
            can turn your idea into a market-leading reality.
          </p>
          <Button
            variant="btnSecondary"
            size="xl"

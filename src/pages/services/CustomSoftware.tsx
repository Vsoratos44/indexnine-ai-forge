        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-foreground-dark leading-relaxed font-montserrat">
              ...
              build, every line of code we write, and every system we deploy is
              directly tied to a validated business need and a measurable
              outcome. We mitigate risk and guarantee value by architecting for
        ...
        <div className="container mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-foreground-dark/80 max-w-3xl mx-auto font-montserrat">
              ...
              cutting-edge technologies and industry best practices across the
            ...
            <div className="bg-gradient-card backdrop-blur-xl rounded-3xl p-12 shadow-glass-lg border border-glass-border">
              <div className="text-left mb-8">
                ...
                <p className="text-lg text-foreground/80 font-montserrat">
                  ...
                  <strong>Strategic Scoping Session</strong> is the ideal first
                  step. This is a 1-2 week, fixed-price engagement where our
                  senior architects partner with you to define project scope,
                  create initial wireframes, map out the technical architecture,
                  and provide a detailed project plan with a firm estimate.
                </p>
              </div>

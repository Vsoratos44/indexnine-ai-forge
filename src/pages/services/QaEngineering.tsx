              ...
              <div className="max-w-4xl bg-[#fff] p-8 rounded-3xl mx-auto">
                ...
                <div>
                  <p className="text-lg text-foreground-dark mb-6">
                    A rapidly scaling B2B Travel Platform client was crippled by
                    a 5-day manual regression testing cycle, blocking their
                  ...
                  <blockquote className="bg-[#F1F2FF] flex rounded-xl mt-12">
                    ...
                    <div className="p-8">
                      <p className="text-foreground-dark mb-2">
                        ...
                        minutes has fundamentally changed how we build and ship
                        product. They are true partners in quality."
                      </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <p className="text-lg text-foreground-dark-muted max-w-6xl mx-auto text-center mb-12">
              ...
              cross-browser nightmares of legacy frameworks are over. Two modern
              titans have emerged to address these pains: Robot Framework and
              Playwright. They deliver the speed, reliability, and
              developer-friendliness that modern quality engineering services
              have been missing.
            </p>

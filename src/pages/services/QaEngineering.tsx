        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground-white mb-8 leading-tight font-montserrat">
              Quality Assurance <span className="bg-gradient-primary bg-clip-text text-transparent">Engineering</span>
            </h1>
            <p className="text-xl text-foreground-white/80 mb-12 leading-relaxed font-montserrat">
              Ensure software excellence with comprehensive testing strategies and automated quality assurance processes.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="hero" size="xl">Improve Quality</Button>
              <Button variant="hero-secondary" size="xl">View Testing Solutions</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: TestTube, title: "Automated Testing", description: "Comprehensive test automation frameworks for faster, reliable testing cycles." },
              { icon: Shield, title: "Security Testing", description: "Vulnerability assessments and penetration testing to ensure secure applications." },
              { icon: Zap, title: "Performance Testing", description: "Load, stress, and performance testing to optimize application responsiveness." },
              { icon: Target, title: "Functional Testing", description: "Manual and automated functional testing to validate business requirements." },
      ...
      <section className="py-24 bg-gradient-hero">
        <div className="container mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-foreground-white/80 mb-12 max-w-2xl mx-auto font-montserrat">
            Partner with us to implement world-class quality assurance processes that ensure your software meets the highest standards.
          </p>
          <Button variant="hero" size="xl">Enhance Your QA</Button>
        </div>
      </section>

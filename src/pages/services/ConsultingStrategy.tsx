                ...
                <CardContent className="p-0">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-3">
                      ...
                      <span className="text-foreground-muted font-montserrat">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="p-8 text-center">
                <CardContent className="p-0">
                  ...
                  <p className="text-foreground-muted mb-6 font-montserrat">
                    Continuous strategic guidance and support as your trusted
                    technology advisor.
                  </p>
                  <Button variant="outline" className="w-full">
                    Learn More
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <Card className="p-6 text-left">
                <CardContent className="p-0">
                  ...
                  <p className="text-foreground-muted font-montserrat">
                    We don't just provide strategies - we can execute them with
              ...
              <Card className="p-6 text-left">
                <CardContent className="p-0">
                  ...
                  <p className="text-foreground-muted font-montserrat">
                    Every recommendation is backed by clear business value and
                    measurable outcomes.
                  </p>
                </CardContent>
              </Card>

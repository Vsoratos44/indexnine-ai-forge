        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground-white mb-8 leading-tight font-montserrat">
              Dedicated <span className="bg-gradient-primary bg-clip-text text-transparent">Teams</span>
            </h1>
            <p className="text-xl text-foreground-white/80 mb-12 leading-relaxed font-montserrat">
              Extend your development capacity with dedicated teams that integrate seamlessly with your existing processes and culture.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="hero" size="xl">Build Your Team</Button>
              <Button variant="hero-secondary" size="xl">Learn More</Button>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-foreground mb-6 font-montserrat">Dedicated Team Benefits</h2>
            <p className="text-xl text-foreground-muted max-w-3xl mx-auto font-montserrat">
              Get the best of both worlds - dedicated resources with the flexibility and expertise of our team.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Users, title: "Expert Team Members", description: "Carefully selected professionals with proven expertise in your technology stack." },
              { icon: Clock, title: "Full-Time Commitment", description: "100% dedicated resources focused exclusively on your project and goals." },
              { icon: Shield, title: "Seamless Integration", description: "Teams that integrate smoothly with your existing processes and workflows." },
              { icon: Target, title: "Aligned Objectives", description: "Team members aligned with your business objectives and success metrics." },
              { icon: Zap, title: "Rapid Scaling", description: "Quickly scale your team up or down based on project requirements." },
              { icon: CheckCircle, title: "Proven Methodology", description: "Established processes and best practices for efficient collaboration." }
            ].map((benefit, index) => (
      ...
      <section className="py-24 bg-gradient-hero">
        <div className="container mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-foreground-white/80 mb-12 max-w-2xl mx-auto font-montserrat">
            Let's discuss how our dedicated teams can accelerate your development goals and deliver exceptional results.
          </p>

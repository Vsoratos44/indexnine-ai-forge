            ...
            <div className="text-center mb-16">
              <h2 className="text-4xl lg:text-5xl max-w-6xl mx-auto font-semibold text-foreground-dark">
                <span className="leading-[1.25]">
                  The Indexnine Difference: Your Team, Supercharged by Our
                  Studios
                </span>
              </h2>
              <p className="text-xl text-foreground-dark/80 mt-4 max-w-3xl mx-auto">
                An Indexnine dedicated team is an "Integrated Pod"—a cohesive
                unit that becomes a seamless extension of your organization,
                backed by the collective intelligence of our entire company.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-8 max-w-7xl mx-auto">
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 text-left">
                ...
                <p className="text-foreground-dark/80">
                  We provide fully managed teams with established chemistry and
                  a shared commitment to our pragmatic engineering principles.
                  They operate as a single, high-performance unit.
                </p>
              </div>
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 text-left">
                <div
                ...
                <p className="text-foreground-dark/80">
                  Your dedicated team is a gateway to our entire company. When
                  you need to solve a complex AI problem, run a performance
                  audit, or refine a UX flow, your team has direct access to our
                  specialized studios.
                </p>
              </div>
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 text-left">
                ...
                <p className="text-foreground-dark/80">
                  ...
                  their ability to help you achieve your business goals, not
                  just close tasks.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 sm:px-6">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-8">
                ...
                <h2 className=" sm:text-4xl lg:text-5xl font-semibold mb-3 text-foreground-dark font-montserrat">
                ...
                <p className="text-sm sm:text-base text-foreground-dark/70 max-w-3xl mx-auto font-montserrat">
                  Beyond staff augmentation—we deploy integrated pods that
                  operate as a seamless extension of your team. Our pods combine
                  senior architects, full-stack engineers, and specialized
                  talent with strategic context and proprietary tooling.
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    ...
                    },
                    {
                      ...
                      icon: (
                        <RefreshCcwDot className="w-6 h-6 text-brand-primary" />
                      ),
                      composition: [
                    ...
                    >
                      <div className="flex flex-col h-full">
                        <div className="flex items-center">
                          <div
                            className={`relative w-16 h-16 flex mb-4 items-center justify-center transition-all ${styles.icnBg}`}
                          >
                            {pod.icon}
                          </div>
                        ...
                        <div className="mb-3">
                          <h4 className="text font-semibold text-foreground-dark mb-1.5">
                            Pod Composition:
                          </h4>
                          <ul className="space-y-1">
                            {pod.composition.map((member, idx) => (
                              <li
                                key={idx}
                                className="text text-foreground-dark flex items-center gap-1.5 font-montserrat"
                              >
                        ...
                        <div className="pt-2.5 border-t border-foreground-dark/10 mt-auto">
                          <p className="text text-foreground-dark/70 mb-1.5 font-montserrat">
              ...
              <div className="grid grid-cols-2 container p-0 pt-8 bg-transparent gap-16">
                      ...
                      <div key={index}>
                        <div className="p-0">
                          <div className="flex gap-2">
                            ...
                            <div>
                              <h4 className="font-semibold text-foreground-dark mb-0 text font-montserrat">
                                {item.title}
                              </h4>
                              <p className="text text-foreground-dark leading-relaxed mb-2 font-montserrat">
                                {item.description}
                              </p>
                            </div>
                          </div>
                ...
                >
                  <div className="text mb-4">
                    ...
                    <p className="text text-foreground-dark/80 mt-4 max-w-3xl mx-auto">
                  ...
                  <div className="max-w-6xl grid grid-cols-2">
                    {[
                      { icon: Wrench, name: "Full-Stack Engineers" },
                      { icon: Users2, name: "UI Developers" },
                      { icon: Palette, name: "UX Designers" },
                      ...
                      >
                        ...
                        >
                          <role.icon className="w-5 h-5 text-brand-primary" />
                        </div>
            ...
            <div className="container mx-auto px-6">
              <div className="max-w-4xl mx-auto text-center mb-16">
                ...
                <p className="text-xl text-foreground-dark/80 mt-4">
                  Every Indexnine Integrated Pod comes with a full support

...
const DataEngineering = () => {
  return (
    <div className="min-h-screen bg-background-dark">
      ...
      <section id="data-solutions" className="py-24 bg-gradient-hero relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground-white mb-8 leading-tight font-montserrat">
              Data Solutions <span className="bg-gradient-primary bg-clip-text text-transparent">in Action</span>
            </h2>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 mb-16">
              ...
              <div className="space-y-6">
                ...
                <h3 className="text-2xl font-bold text-foreground-white">
                  From Legacy Chaos to Cloud-Native Clarity
                </h3>
                <p className="text-foreground-white/80 mb-6">
                ...
                <blockquote className="mt-8 p-6 bg-background-card-light rounded-xl border-l-4 border-brand-primary">
                  <p className="text-foreground-white italic mb-3">
                  ...
                  <footer className="text-sm text-foreground-white/70 font-medium">

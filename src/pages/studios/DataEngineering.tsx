        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8 pt-32 pb-24">
          <div className="max-w-5xl mx-auto text-center lg:text-left">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-foreground/85 mb-12 max-w-4xl leading-relaxed font-light animate-slide-up">
              We design and build intelligent data platforms that drive clarity,
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-foreground-dark-muted mb-12 max-w-3xl mx-auto">
              Many businesses have mountains of data but struggle to turn it
              into an actionable intelligence platform. Legacy systems, data
              silos, and poor data quality create a significant gap between data
              investment and business value, with 85% of AI projects failing to
              deliver results due to inadequately prepared data.
            </p>
          </div>
        </div>
      </section>

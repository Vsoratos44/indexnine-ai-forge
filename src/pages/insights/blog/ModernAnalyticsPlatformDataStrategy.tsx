...
const leftNavLinks = [
  ...
  {
    href: "#blueprint",
    label: "The Blueprint for a Modern Analytics Platform",
  },
...
const ModernAnalyticsPlatformDataStrategy = () => {
  ...
  return (
    <div
      className="min-h-screen md:bg-contain  bg-no-repeat bg-white"
            ...
            <section className="pt-12 pb-0 relative ">
              <div className=" text-lg text-foreground-dark-muted leading-relaxed">
                <div className="max-w-5xl mx-auto">
                  <div className="space-y-6">
                    <h2 className="font-semibold text-2xl text-foreground-dark">
                      The Blueprint for a Modern Analytics Platform: A Four-Step
                      Journey
                    </h2>
                    <p>
                      Building a modern, AI-ready analytics platform is a
                      journey that transforms your data environment into an
      ...
      {/* <section className={`py-24 lg:py-32 ${styles.ctaBg}`}>
        <div className="container mx-auto px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-foreground-white/80 mb-12 max-w-2xl mx-auto font-montserrat">
            Transform your data infrastructure with our proven blueprint and
            expert guidance.
          </p>

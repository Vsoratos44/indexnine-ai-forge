...
import { ArrowLeft, CheckCircle, Download, ExternalLink, Clock, User } from 'lucide-react';
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Article',
            headline: 'Robot Framework vs Playwright: Which Test Automation Service is Right for You?',
            description: 'A deep dive into Robot Framework vs Playwright for enterprise-grade test automation. See which framework powers a better continuous testing and QA process.',
            ...
            mainEntityOfPage: {
              '@type': 'WebPage',
              '@id': 'https://yoursite.lovable.app/insights/blogs/robot-framework-vs-playwright-automation'
            }
          })
        }}
      />
      ...
      <section className="relative h-[65vh] min-h-[600px] overflow-hidden bg-gradient-hero">
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8 pt-32 pb-24">
          <div className="max-w-5xl mx-auto">
            <Link to="/insights/blogs" className="inline-flex items-center text-brand-primary hover:text-brand-primary-dark transition-colors mb-8">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-8 leading-tight tracking-tight animate-fade-in font-montserrat">
              ...
              <span className="bg-gradient-primary bg-clip-text text-transparent">The Test Automation Showdown Your Business Can't Ignore</span>
            </h1>
            ...
            <div className="flex items-center gap-6 text-sm text-foreground/70 mb-8">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="space-y-6 text-lg text-muted-foreground leading-relaxed mb-8">
              ...
              <p>
                ...
                engineering services have been missing. But the critical question isn't just which tool is better—it's 
                which tool is right for your business, your team, and your growth stage.
              </p>
              <p>
            ...
            <div className="bg-brand-primary/5 border border-brand-primary/20 rounded-xl p-8 my-12">
              <Button variant="hero" className="w-full max-w-md mx-auto block">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border border-glass-border rounded-3xl overflow-hidden bg-glass-bg/50 backdrop-blur-xl shadow-glass">
                <thead className="bg-brand-primary/10">
                  <tr>
                    <th className="text-left p-6 font-montserrat text-foreground-dark font-semibold">Feature</th>
                    <th className="text-center p-6 font-montserrat text-foreground-dark font-semibold">Robot Framework</th>
                    <th className="text-center p-6 font-montserrat text-foreground-dark font-semibold">Playwright</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-t border-glass-border">
                    <td className="p-6 font-medium text-foreground-dark">Ideal Use Case</td>
                    <td className="p-6 text-center text-foreground-dark">Startups (Seed-Series A), MVPs, teams needing broad testing capabilities (Web, API, Mobile).</td>
                    <td className="p-6 text-center text-foreground-dark">Scale-ups (Series B+), complex web apps, teams demanding high-velocity and parallel execution.</td>
                  </tr>
                  <tr className="border-t border-glass-border bg-glass-bg/30">
                    <td className="p-6 font-medium text-foreground-dark">Key Strength</td>
                    <td className="p-6 text-center text-foreground-dark">Readability & Accessibility: Keyword-driven syntax is easy for technical and non-technical staff to understand.</td>
                    <td className="p-6 text-center text-foreground-dark">Speed & Reliability: Modern architecture with auto-waits and web-first assertions minimizes flaky tests.</td>
                  </tr>
                  <tr className="border-t border-glass-border">
                    <td className="p-6 font-medium text-foreground-dark">Ecosystem</td>
                    <td className="p-6 text-center text-foreground-dark">Python-based, with a massive ecosystem of libraries for any task, including a wrapper for Playwright itself.</td>
                    <td className="p-6 text-center text-foreground-dark">Native support for TypeScript, JavaScript, Python, Java, and .NET, fitting seamlessly into developer workflows.</td>
                  </tr>
                  <tr className="border-t border-glass-border bg-glass-bg/30">
                    <td className="p-6 font-medium text-foreground-dark">Best For...</td>
                    <td className="p-6 text-center text-foreground-dark">Teams aiming to democratize test creation, implement Test-Driven Development (TDD), and require a gentle learning curve.</td>
                    <td className="p-6 text-center text-foreground-dark">Developer-centric teams focused on efficiency, deep debugging (Trace Viewer), and continuous testing of modern, complex web applications.</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <section className="py-24 lg:py-32 bg-background relative overflow-hidden">
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <h3 className="text-2xl font-bold text-brand-primary-dark mb-6 font-montserrat">Why Robot Framework is a Founder's Best Friend</h3>
      ...
      <section className="py-24 lg:py-32 bg-background relative overflow-hidden">
        <div className="container mx-auto px-6 lg:px-8 relative z-10">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="relative overflow-hidden backdrop-blur-xl bg-glass-bg border border-glass-border rounded-3xl p-8 shadow-glass">
              <h3 className="text-2xl font-bold text-brand-primary-dark mb-6 font-montserrat">This is how we execute:</h3>

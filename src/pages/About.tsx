      ...
      <section className="relative h-[65vh] min-h-[600px] overflow-hidden bg-gradient-hero">
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8 pt-32 pb-24">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-lg sm:text-xl lg:text-2xl text-foreground/85 mb-12 max-w-4xl mx-auto leading-relaxed font-light animate-slide-up font-montserrat">
      ...
      <section className="py-24 lg:py-32 bg-background">
        <div className="container mx-auto px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12 max-w-7xl mx-auto">
            ...
            <div
              className="relative overflow-hidden backdrop-blur-xl bg-glass-bg border border-glass-border rounded-3xl p-8 lg:p-10 shadow-glass hover:shadow-glass-lg transition-all duration-500 transform hover:scale-105 hover:-translate-y-2 animate-fade-in"
            ...
            >
              ...
              <p className="text-foreground-muted leading-relaxed text-lg font-light font-montserrat">
                We leverage artificial intelligence not as a buzzword, but as a
                core tool to solve complex problems and create competitive
                advantages.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-foreground-muted leading-relaxed text-lg font-light font-montserrat">
                Our success is measured by your success. We put skin in the game
                with outcome-based models that align our incentives with your
                goals.
              </p>
            </div>
          </div>

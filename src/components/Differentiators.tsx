  ...
  const differentiators = [
    {
      ...
      description:
        "Backed by leading private equity investors, we provide the financial stability and security that ensures long-term partnership reliability.",
    ...
    },
    {
      ...
      description:
        "Our engineers aren't just coders – they're product thinkers who understand business goals and can translate it into technical solutions.",
    ...
    },
    {
      ...
      description:
        "We integrate AI capabilities into every solution we build, ensuring your products are future-proof and leverage the latest advancements.",
    ...
    >
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center mb-20">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-foreground-light mb-8 leading-tight tracking-tight">

...
export const ScalePhaseSection: React.FC = () => {
  const primeSteps = [
    { letter: "P", title: "Plan", description: "Define AI vision aligned with business OKRs." },
    { letter: "R", title: "Recruit", description: "Establish the CoE, identify champions, and build governance." },
    { letter: "I", title: "Inspire", description: "Deploy role-specific training, create sandboxes, and launch hackathons." },
    { letter: "M", title: "Motivate", description: "Implement recognition systems and reward contributions." },
    { letter: "E", title: "Evolve", description: "Track productivity gains and scale successful initiatives." },
  ];
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold mb-6 text-foreground-white">
              ...
              <span className="text-brand-primary">AI Center of Excellence</span>
            </h2>
            <p className="text-lg text-foreground-light-muted max-w-4xl mx-auto">
              ...
              (CoE), turning your initial investment into a long-term competitive
              advantage.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            {/* Feature 1 */}
            <Card className="relative overflow-hidden bg-gradient-card-light border border-[#ffffff39] rounded-2xl p-8 hover:border-brand-primary/30 transition-all duration-500 bg-white-600 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20">
              <div className="absolute inset-0 bg-gradient-to-br from-brand-primary/8 via-transparent to-brand-purple/8 rounded-2xl opacity-0 hover:opacity-100 transition-opacity duration-500" />
          ...
          <div className="mb-12">
            <h3 className="text-2xl font-semibold text-center text-foreground-light mb-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
              {primeSteps.map((step, index) => (
                ...
                >
                  <div className="bg-gradient-to-br from-[#ffffff10] to-[#ffffff05] border border-[#ffffff20] rounded-xl p-6 text-center hover:border-brand-primary/40 transition-all duration-300">

      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-left mb-12">
          ...
          <p className="text-lg text-foreground-dark-muted max-w-3xl mx-auto">
            In the world of AI, trust is paramount. An AI product that produces
            unreliable or inaccurate results is worse than no product at all.
            Our "Eval-First" engineering principle is our commitment to building
            AI you and your customers can depend on.
          </p>
        </div>
        ...
        <p className="text-lg text-foreground-dark-muted leading-relaxed max-w-3xl">
          Our process is built on a rigorous evaluation framework for all AI and
          agentic features. Before any launch, we use curated prompt suites,
          automated test harnesses, and critical human-in-the-loop validation to
          ensure target accuracy, safety, and performance levels are met. This
          disciplined approach is how we move from a promising prototype to a

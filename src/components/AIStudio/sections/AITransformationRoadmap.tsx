...
const IconCard: React.FC<{
  ...
  return (
    <div
      className={`bg-gradient-to-tr from-[#ffffff01] via-[#ffffff10] to-[#ffffff05] border border-[#ffffff19] bg-clip-padding backdrop-filter backdrop-blur-lg rounded-xl p-6 flex ${className}`}
    >
      <div className="relative rounded-full bg-gradient-to-r from-[#505CFD19] to-brand-purple/20 w-14 h-14 flex items-center justify-center mr-4 border border-white/20 group-hover:shadow-glow transition-all duration-300 group-hover:scale-110 flex-shrink-0">
      ...
      <div>
        ...
        <p className="text-sm text-foreground-white/70">{description}</p>
      </div>
    </div>
  );
};
  ...
  const frameworkCards: FrameworkCard[] = [
    {
      ...
      description: "Quick Wins | Strategic Bets | Early Experiments",
    },
    {
      icon: Award,
      title: 'How to Win (The "HOW" part of transformation)',
      description: "Outcome-oriented Roadmap | Operating-Model",
    },
  ];
      ...
      >
        <div className="container mx-auto px-6">
          <div className="max-w-8xl mx-auto">
            ...
            <div className="sm:grid sm:grid-cols-2 gap-6 mb-6">

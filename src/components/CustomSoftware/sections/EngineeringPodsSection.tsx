      ...
      <div className="container mx-auto px-6">
        <div className="max-w-8xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-foreground-dark/80 max-w-4xl mx-auto mb-6">
              Beyond staff augmentation—we deploy integrated pods that operate as
              a seamless extension of your team.
            </p>
            <p className="text-foreground-dark/70 max-w-4xl mx-auto">
                ...
                return (
                  ...
                  >
                    <CardContent className="p-0 flex-1">
                      <div
                        className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${pod.color} flex items-center justify-center mb-6 shadow-lg`}
                      >
                      ...
                      <div className="mb-4">
                        <h4 className="text-sm font-semibold text-foreground-dark/70 mb-2">
                          Pod Composition:
                        </h4>
                      ...
                      <div className="pt-4 border-t border-foreground-dark/10">
                        <p className="text-sm text-foreground-dark/70 mb-2">
          ...
          <div className="mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {differentiators.map((item, index) => (
                <Card
                  key={index}
                  className="bg-gradient-to-br from-[#F1F2FF] to-white border border-[#00000019] rounded-xl p-6"
                >

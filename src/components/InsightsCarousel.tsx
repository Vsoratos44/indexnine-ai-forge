  ...
  const carouselItems: CarouselItem[] = [
    {
      ...
      description:
        "A comprehensive guide to integrating artificial intelligence into your product development lifecycle for maximum efficiency and innovation.",
    ...
    },
    {
      ...
      description:
        "Exploring emerging trends and technologies that will shape enterprise software development in the next decade.",
    ...
    },
    {
      ...
      description:
        "How we helped a fintech startup scale their platform to handle 10x user growth while maintaining 99.9% uptime.",
    ...
    },
    {
      ...
      description:
        "A step-by-step guide for enterprises looking to modernize their technology stack and processes.",
      date: "January 8, 2025",
    ...
    },
    {
      ...
      description:
        "Essential patterns and practices for building scalable, maintainable microservices architectures.",
      date: "January 5, 2025",
      ...
      <div className="container-full mx-auto px-0 lg:px-0 relative z-10">
        <div className="container text-center mb-20">
          ...
          <p className="text-xl text-foreground-dark-muted max-w-3xl mx-auto font-light font-montserrat">
            Discover insights, strategies, and success stories that drive
